...
struct in_unit_interval {
	static_assert(std::is_arithmetic<arithmetic_type>::value, "arithmetic_type must satisfy std::is_arithmetic");
...
struct arithmetic_invariant : invariant_unary_checker {
	...
	arithmetic_invariant operator=(other_arithmetic_type other) {
		static_assert(
			std::is_arithmetic<other_arithmetic_type>::value,
...
auto operator+(
	const arithmetic_invariant<arithmetic_type, invariant_unary_checker> number,
	const arithmetic_invariant<other_arithmetic_type, invariant_unary_checker> other)
{
...
auto operator+(
	const arithmetic_invariant<arithmetic_type, invariant_unary_checker> number,
	const other_arithmetic_type other)
{
